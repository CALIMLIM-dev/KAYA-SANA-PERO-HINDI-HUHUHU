...
class LegalDocuments {
  ...
  static const LegalDocument terms = LegalDocument(
    ...
    sections: [
      ...
      LegalSection(
        'Your Profile',
        'Everything you put on your profile must be true and about you. Skills, work history, certificates and licences you add are shown to other users. KAYA does not check that a certificate or licence is genuine beyond confirming that a file was uploaded. A skill check passed on KAYA is a short test on the trade and is not a professional certification.\n\nA resume you upload can be opened only by an employer you have a pending or accepted application with, and only while that application is open.',
      ),
      LegalSection(
        'Barya',
